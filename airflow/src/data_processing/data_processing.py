...
def load_data(filepath):
        ...
        with open("/app/data/models/mapper.pkl", "wb") as fichier:
...
if __name__ == "__main__":
    ##Variable definition
    filepath_source = "/app/data/preprocessed"
    filepath_dest = "/app/data/processed"
    img_filepath="/app/data/preprocessed/images/images/image_train"
